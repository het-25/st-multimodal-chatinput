...
/** @ignore */
export declare type BuilderType<T extends Type | DataType = any, TNull = any> = T extends Type ? TypeToBuilder<T, TNull> : T extends DataType ? DataTypeToBuilder<T, TNull> : Builder<any, TNull>;
/** @ignore */
export declare type BuilderCtor<T extends Type | DataType = any> = T extends Type ? BuilderCtorType<BuilderType<T>> : T extends DataType ? BuilderCtorType<BuilderType<T>> : BuilderCtorType<Builder>;
/** @ignore */
export declare type DataTypeCtor<T extends Type | DataType = any> = T extends DataType ? ConstructorType<T> : T extends Type ? ConstructorType<TypeToDataType<T>> : never;
/** @ignore */
export declare type TypedArrayDataType<T extends TypedArray | BigIntArray> = T extends Int8Array ? type.Int8 : T extends Int16Array ? type.Int16 : T extends Int32Array ? type.Int32 : T extends BigInt64Array ? type.Int64 : T extends Uint8Array ? type.Uint8 : T extends Uint8ClampedArray ? type.Uint8 : T extends Uint16Array ? type.Uint16 : T extends Uint32Array ? type.Uint32 : T extends BigUint64Array ? type.Uint64 : T extends Float32Array ? type.Float32 : T extends Float64Array ? type.Float64 : never;
/** @ignore */
